...
const RegisterPractitioner = () => {
  ...
  const { registerPractitioner, status, error } = useAuthStore();
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      await registerPractitioner(dataToSubmit);
      alert('¡Registro de practicante exitoso! Por favor, inicia sesión.');
      navigate('/login');
    } catch (err) {
      console.error(err);
    }
      ...
      <div className="auth-card">
        ...
        <div className="auth-content">
          ...
          <form onSubmit={handleSubmit}>
            ...
            <div className="input-group">
              <label htmlFor="studyYear">Año de cursado *</label>
              <div className="input-wrapper">
                <FiBookOpen className="icon-left" />
                <input
                  type="number"
                  id="studyYear"
                  name="studyYear"
